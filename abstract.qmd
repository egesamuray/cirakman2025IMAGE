...
::: {#fig-composite .figure-grid}
<div class="figure-grid-item">
![RTM](./figs/rtm483.png){width="100%"}
</div>

<div class="figure-grid-item">
![GT](./figs/483_velo_rainbow.png){width="100%"}
</div>

<div class="figure-grid-item">
![WSGM](./figs/gen8W.png){width="100%"}
</div>

<div class="figure-grid-item">
![SGM](./figs/imagegen4WSGM.png){width="100%"}
</div>
...
<figure id="fig-multiscale" class="multiscale-container quarto-figure quarto-figure-center">
  ...
  <figcaption>Figure 2: Multi-scale visualization showing the progression from coarse to fine resolution in wavelet space. The progression represents the hierarchical nature of the wavelet decomposition, with each level containing increasingly detailed geological structures.</figcaption>
</figure>
```
...
![Comparison of GT, WSGM, and SGM. Posterior samples for WSGM and SGM were generated starting from the same initial noise.](./figs/fig4_s.png){width="50%"}
:::
