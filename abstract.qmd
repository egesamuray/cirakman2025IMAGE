...
csl: ref_styles/ieee-transactions-on-geoscience-and-remote-sensing.csl
crossref:
  fig-title: "Figure"
  fig-prefix: "Figure"
  # fig-labels: "**arabic**"
...
format:
  ...
  arxiv-pdf:
    ...
    # doublespacing: true
  # pdf:
  #   template: template/Neurips_2024.tex
  #   # csl: apa.csl
  #   keep-tex: true
  #   appendix: true
...
![(a) RTM](./figs/rtm483.png){width=90%}

![(b) GT](./figs/483_velo_rainbow.png){width=90%}

![(c) WSGM](./figs/gen8W.png){width=90%}

![(d) SGM](./figs/imagegen4WSGM.png){width=90%}
...
::: {#fig-multiscale layout-ncol=1}
<!-- Arrow -->
<p align="center" style="font-size: 1.0em; margin-bottom: 0.5em;">
  Coarse scale &nbsp; ------------------------------------------------------------------------------------------------------> &nbsp; Fine scale
</p>

<p align="center">
  ![32×32](./figs/j3_.png){#32x32_scale width=6.25%}
  ![64×64](./figs/j2_.png){#64x64_scale width=12.5%}
  ![128×128](./figs/j1_.png){#128x128_scale width=25%}
  ![256×256](./figs/WSGM_m1.png){#256x256_scale width=50%}
</p>
