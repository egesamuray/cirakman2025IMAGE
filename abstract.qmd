...
<span class="math inline">\\(\\def\\textsc#1{\\dosc#1\\csod} \\def\\dosc#1#2\\csod{{\\rm #1{\\small #2}}}\\)</span>
:::
...
![RTM](./figs/rtm483.png){#fig-rtm width="90%"}

![GT](./figs/483_velo_rainbow.png){#fig-gt width="90%"}

![WSGM](./figs/gen8W.png){#fig-wsgm width="90%"}

![SGM](./figs/imagegen4WSGM.png){#fig-sgm width="90%"}
...
::: {#fig-multiscale layout="[[-5,90,-5]]"}
![](./figs/j3_.png){width="6.25%"}
![](./figs/j2_.png){width="12.5%"}
![](./figs/j1_.png){width="25%"}
![](./figs/WSGM_m1.png){width="50%"}
